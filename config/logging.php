    ...
    */
    ...
    'channels' => [
        ...
        'payments' => [
            ...
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => env('LOG_PAYMENTS_DAYS', 365), // Keep payment logs for 1 year
            'replace_placeholders' => true,
        ],

        'brta' => [
            'driver' => 'daily',
            'path' => storage_path('logs/brta/brta.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => env('LOG_BRTA_DAYS', 30),
            'replace_placeholders' => true,
        ],
        ...
        'security' => [
            ...
            'level' => 'warning',
            'days' => env('LOG_SECURITY_DAYS', 180), // Keep security logs for 6 months
            'replace_placeholders' => true,
        ],
        ...
        'warning' => [
            'driver' => 'daily',
            'path' => storage_path('logs/warnings/warning.log'),
            'level' => 'warning',
        ...
        'booking' => [
            ...
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => env('LOG_BOOKING_DAYS', 60),
            'replace_placeholders' => true,
        ],

        'vehicles' => [
            'driver' => 'daily',
            'path' => storage_path('logs/vehicles/vehicles.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => env('LOG_VEHICLES_DAYS', 30),
            'replace_placeholders' => true,
        ],
