...
return [
    ...
    'invoices' => [
        ...
        'create_title' => 'চালান তৈরি করুন',
        'create_new_invoice' => 'নতুন চালান তৈরি করুন',
        'create_invoice' => 'চালান তৈরি করুন',
        'select_parking_session' => 'চালান তৈরি করতে একটি পার্কিং সেশন নির্বাচন করুন',
        'select_session' => 'পার্কিং সেশন নির্বাচন করুন',
        'search_session' => 'লাইসেন্স প্লেট বা জোন দ্বারা অনুসন্ধান করুন...',
        'no_sessions_available' => 'চালান করার জন্য কোনো পার্কিং সেশন উপলব্ধ নেই',
        'invoice_summary' => 'চালান সারাংশ',
        'base_amount' => 'মূল পরিমাণ',
        'tax' => 'ট্যাক্স',
        'total' => 'মোট',
        'invoice_info' => 'চালান তথ্য',
        'how_it_works' => 'এটি কীভাবে কাজ করে',
        'step_1' => 'তালিকা থেকে একটি সম্পন্ন পার্কিং সেশন নির্বাচন করুন',
        'step_2' => 'চালান সারাংশ এবং বিবরণ পর্যালোচনা করুন',
        'step_3' => 'চালান তৈরি করতে "চালান তৈরি করুন" ক্লিক করুন',
        'step_4' => 'চালান সিস্টেমে যোগ করা হবে',
        'session_statistics' => 'সেশন পরিসংখ্যান',
        'total_available' => 'মোট উপলব্ধ সেশন',
