...
<div class="top-bar">
        ...
        <div class="search-result">
            <div class="search-result__content">
                ...
                <div class="mb-5">
                    ...
                    <a href="{{ route('admin.vehicles.pending') }}" class="flex items-center mt-2">
                    ...
                    <a href="{{ route('admin.reports.index') }}" class="flex items-center mt-2">
            ...
            <div class="notification-content__box dropdown-content">
                ...
                <div class="cursor-pointer relative flex items-center">
                    <div class="w-12 h-12 flex-none image-fit mr-1">
                        <img alt="Avatar" class="rounded-full" src="{{ asset('backend/ui/images/fakers/profile-4.jpg') }}">
                ...
                <div class="cursor-pointer relative flex items-center mt-5">
                    <div class="w-12 h-12 flex-none image-fit mr-1">
                        <img alt="Avatar" class="rounded-full" src="{{ asset('backend/ui/images/fakers/profile-2.jpg') }}">
                        <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                    </div>
                    <div class="ml-2 overflow-hidden">
                        <div class="flex items-center">
    ...
    <div class="intro-x dropdown w-8 h-8">
        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-tw-toggle="dropdown">
            <img alt="User Profile" src="{{ asset('backend/ui/images/fakers/profile-1.jpg') }}">
        </div>
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                ...
                <li>
                    <a href="{{ route('admin.dashboard.index') }}" class="dropdown-item hover:bg-white/5">
                ...
                <li>
                    <a href="{{ route('logout') }}" class="dropdown-item hover:bg-white/5" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
