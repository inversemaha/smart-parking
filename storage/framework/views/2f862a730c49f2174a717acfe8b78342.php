        ...
        <div class="col-span-12 lg:col-span-8">
            <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="intro-y box">
                    ...
                    <div class="p-5 space-y-4">
                        <div>
                            ...
                            <input type="text" name="system_name" value="<?php echo e($settings['system_name'] ?? 'Parking Management System'); ?>"
                        ...
                        <div>
                            ...
                            <textarea name="system_description" placeholder="Brief description of your system"
                                class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" rows="3"><?php echo e($settings['system_description'] ?? ''); ?></textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="tel" name="support_phone" value="<?php echo e($settings['support_phone'] ?? ''); ?>"
                        ...
                        <div>
                            ...
                            <input type="url" name="support_website" value="<?php echo e($settings['support_website'] ?? ''); ?>"
                    ...
                    <div class="p-5 space-y-4">
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" name="hourly_rate" step="0.01" value="<?php echo e($settings['hourly_rate'] ?? '50'); ?>"
                                    placeholder="50"
                                    class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="daily_rate" step="0.01" value="<?php echo e($settings['daily_rate'] ?? '300'); ?>"
                                    placeholder="300"
                                    class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="monthly_rate" step="0.01" value="<?php echo e($settings['monthly_rate'] ?? '5000'); ?>"
                                    placeholder="5000"
                                    class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="time" name="operating_hours_from" value="<?php echo e($settings['operating_hours_from'] ?? '06:00'); ?>"
                                    class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>

                            <div>
                                <label class="block text-sm font-semibold text-slate-700 mb-2">Operating Hours (To)</label>
                                <input type="time" name="operating_hours_to" value="<?php echo e($settings['operating_hours_to'] ?? '22:00'); ?>"
                                    class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>
                        </div>
                        ...
                        <div>
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="enable_24_hours" value="1" 
                                    <?php echo e(isset($settings['enable_24_hours']) && $settings['enable_24_hours'] ? 'checked' : ''); ?>
                    ...
                    <div class="p-5 space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="tax_rate" step="0.01" value="<?php echo e($settings['tax_rate'] ?? '15'); ?>"
                                    placeholder="15"
                                    class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="currency"
                                    class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                                    <option value="BDT" <?php echo e(($settings['currency'] ?? 'BDT') === 'BDT' ? 'selected' : ''); ?>>BDT (Taka)</option>
                                    <option value="USD" <?php echo e(($settings['currency'] ?? 'BDT') === 'USD' ? 'selected' : ''); ?>>USD (Dollar)</option>
                                    <option value="INR" <?php echo e(($settings['currency'] ?? 'BDT') === 'INR' ? 'selected' : ''); ?>>INR (Rupee)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="payment_gateway"
                                class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                                <option value="sslcommerz"<?php echo e(($settings['payment_gateway'] ?? 'sslcommerz') === 'sslcommerz' ? 'selected' : ''); ?>>SSLCommerz</option>
                                <option value="stripe" <?php echo e(($settings['payment_gateway'] ?? 'sslcommerz') === 'stripe' ? 'selected' : ''); ?>>Stripe</option>
                                <option value="manual" <?php echo e(($settings['payment_gateway'] ?? 'sslcommerz') === 'manual' ? 'selected' : ''); ?>>Manual Payment</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="smtp_port" value="<?php echo e($settings['smtp_port'] ?? '2525'); ?>"
                                    placeholder="2525"
                                    class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>
                        ...
                        <div>
                            ...
                            <input type="email" name="from_email" value="<?php echo e($settings['from_email'] ?? ''); ?>"
                    ...
                    <div class="p-5 space-y-4">
                        <div>
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="maintenance_mode" value="1" 
                                    <?php echo e(isset($settings['maintenance_mode']) && $settings['maintenance_mode'] ? 'checked' : ''); ?>
                        ...
                        <div>
                            ...
                            <textarea name="maintenance_message" placeholder="System is under maintenance. Please try again later."
                                class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" rows="2"><?php echo e($settings['maintenance_message'] ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex gap-3">
                    ...
                    <a href="<?php echo e(route('admin.dashboard.index')); ?>" class="px-6 py-2 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors font-semibold">
                        Cancel
                    </a>
                </div>
            </form>
        ...
        <div class="col-span-12 lg:col-span-4">
            ...
            <div class="intro-y box">
                ...
                <div class="p-5 space-y-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-slate-900"><?php echo e(now()->format('M d, Y H:i')); ?></p>
                    </div>
                    <div>
            ...
            <div class="intro-y box mt-6">
                ...
                <div class="p-5 space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.system.logs')); ?>" class="flex items-center gap-2 text-primary hover:text-primary/80 font-semibold text-sm">
                        <i data-lucide="activity" class="w-4 h-4"></i>View System Logs
                    </a>
                    <a href="<?php echo e(route('admin.system.health')); ?>" class="flex items-center gap-2 text-primary hover:text-primary/80 font-semibold text-sm">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /media/bot/7E246BE4246B9DC1/laragon/www/parking/resources/views/admin/system/settings.blade.php ENDPATH**/ ?>