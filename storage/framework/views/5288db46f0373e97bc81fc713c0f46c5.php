    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title"><?php echo e(__('general.select_language')); ?></h2>
            ...
            <div class="modal-body">
                <div class="space-y-4">
                    <div class="text-sm text-gray-600 mb-4">
                        <?php echo e(__('general.language_description')); ?>

                    </div>

                    <form method="POST" action="<?php echo e(route('visitor.language.switch', 'en')); ?>" class="inline-block w-full">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="flex items-center w-full p-4 border-2 rounded-lg transition-all duration-200 <?php echo e(app()->getLocale() === 'en' ? 'border-primary bg-primary/10' : 'border-gray-200 hover:border-gray-300'); ?>">
                    ...
                    <form method="POST" action="<?php echo e(route('visitor.language.switch', 'bn')); ?>" class="inline-block w-full">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="flex items-center w-full p-4 border-2 rounded-lg transition-all duration-200 <?php echo e(app()->getLocale() === 'bn' ? 'border-primary bg-primary/10' : 'border-gray-200 hover:border-gray-300'); ?>">
                            <div class="flex items-center space-x-3">
...
<?php /**PATH /media/bot/7E246BE4246B9DC1/laragon/www/parking/resources/views/visitor/partials/language-modal.blade.php ENDPATH**/ ?>