<?php $__env->startSection('title', __('general.admin_dashboard')); ?>
<?php $__env->startSection('page-title', __('general.admin_dashboard')); ?>
...
<?php $__env->startSection('content-class', 'mt-3'); ?>
                    ...
                    <div class="box sm:flex">
                        <div class="px-8 py-12 flex flex-col justify-center flex-1">
                            ...
                            <div class="relative text-3xl font-medium mt-12 pl-4 ml-0.5">
                                ...
                                <?php echo e(number_format($stats['payments']['total_amount'], 0)); ?>

                            </div>
                            <div class="text-slate-500">Total revenue from parking services</div>
                            <a href="<?php echo e(route('admin.reports.index')); ?>" class="btn btn-outline-secondary relative justify-start rounded-full mt-12">
                                View Reports
                        ...
                        <div class="px-8 py-12 flex flex-col justify-center flex-1 border-t sm:border-t-0 sm:border-l border-slate-200 dark:border-darkmode-300 border-dashed">
                            ...
                            <div class="mt-1.5 flex items-center">
                                <div class="text-base font-medium"><?php echo e($stats['users']['total']); ?></div>
                            </div>

                            <div class="text-slate-500 text-xs mt-5">TOTAL VEHICLES</div>
                            <div class="mt-1.5 flex items-center">
                                <div class="text-base font-medium"><?php echo e($stats['vehicles']['total']); ?></div>
                                <?php if($stats['vehicles']['pending'] > 0): ?>
                                    <div class="text-warning flex text-xs font-medium tooltip cursor-pointer ml-2" title="Pending verification">
                                        <?php echo e($stats['vehicles']['pending']); ?> <i data-lucide="alert-circle" class="w-4 h-4 ml-0.5"></i>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mt-1.5 flex items-center">
                                <div class="text-base font-medium"><?php echo e($stats['bookings']['total']); ?></div>
                            </div>

                            <div class="text-slate-500 text-xs mt-5">NEW USERS (THIS WEEK)</div>
                            <div class="mt-1.5 flex items-center">
                                <div class="text-base font-medium"><?php echo e($stats['users']['new_week']); ?></div>
            ...
            <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3 mt-2">
                ...
                <div class="report-box-2 intro-y mt-5">
                    <div class="box p-5">
                        ...
                        <div class="text-2xl font-medium mt-2"><?php echo e($stats['bookings']['active']); ?></div>
                        <div class="border-b border-slate-200 flex pb-2 mt-4">
                            ...
                            <div class="text-success flex text-xs font-medium tooltip cursor-pointer ml-auto" title="Completion rate">
                                <?php echo e($completion_rate); ?>% <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i>
                            </div>
                        </div>
                        <div class="mt-4">
                            <div class="text-slate-500 text-xs flex mb-2 pb-2">
                                <div>Today's Bookings</div>
                                <div class="ml-auto font-medium"><?php echo e($stats['bookings']['today']); ?></div>
                            </div>
                            <div class="text-slate-500 text-xs flex">
                                <div>Completed</div>
                                <div class="ml-auto font-medium"><?php echo e($stats['bookings']['completed']); ?></div>
                            </div>
                        </div>
                        <a href="<?php echo e(route('admin.reports.bookings')); ?>" class="btn btn-outline-secondary border-dashed w-full py-1 px-2 mt-4">Booking Report</a>
                    </div>
                </div>
            </div>
            <!-- END: Active Sessions -->
                    ...
                    <div class="box p-5">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-lg font-medium"><?php echo e($stats['users']['active']); ?></div>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="text-xs text-slate-500">New This Week</div>
                                <div class="text-lg font-medium text-success"><?php echo e($stats['users']['new_week']); ?></div>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="text-xs text-slate-500">New Today</div>
                                <div class="text-lg font-medium text-primary"><?php echo e($stats['users']['new_today']); ?></div>
                            </div>
                            <div class="flex items-center justify-between border-t pt-4">
                                <div class="text-xs text-slate-500">Total Users</div>
                                <div class="text-xl font-medium"><?php echo e($stats['users']['total']); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="intro-y box p-5 mt-12 sm:mt-5">
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div class="text-center">
                            <div class="text-3xl font-medium"><?php echo e($stats['vehicles']['total']); ?></div>
                            <div class="text-slate-500 text-xs mt-2">Total Vehicles</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-medium text-success"><?php echo e($stats['vehicles']['verified']); ?></div>
                            <div class="text-slate-500 text-xs mt-2">Verified</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-medium text-warning"><?php echo e($stats['vehicles']['pending']); ?></div>
                            <div class="text-slate-500 text-xs mt-2">Pending</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-medium text-danger"><?php echo e($stats['vehicles']['rejected']); ?></div>
                            <div class="text-slate-500 text-xs mt-2">Rejected</div>
                        </div>
                    </div>
                    <?php if($stats['vehicles']['pending'] > 0): ?>
                        <div class="mt-6">
                            <a href="<?php echo e(route('admin.vehicles.pending')); ?>" class="btn btn-outline-primary">
                                <i data-lucide="alert-circle" class="w-4 h-4 mr-2"></i> Review <?php echo e($stats['vehicles']['pending']); ?> Pending Vehicle(s)
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="box px-5 py-4 mb-3">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <div class="text-2xl font-medium mt-1">$<?php echo e(number_format($stats['payments']['total_amount'], 0)); ?></div>
                                </div>
                        ...
                        <div class="box px-5 py-4 mb-3">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <div class="text-2xl font-medium mt-1">$<?php echo e(number_format($stats['payments']['month_amount'], 0)); ?></div>
                                </div>
                                <div class="text-center">
                        ...
                        <div class="box px-5 py-4 mb-3">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <div class="text-2xl font-medium mt-1">$<?php echo e(number_format($stats['payments']['today_amount'], 0)); ?></div>
                                </div>
                                <i data-lucide="dollar-sign" class="w-10 h-10 text-primary opacity-50"></i>
                            </div>
                        </div>
                    </div>
                    <?php if($stats['payments']['pending'] > 0): ?>
                        <div class="intro-y">
                            <div class="box px-5 py-4 border-l-4 border-warning">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <div class="text-slate-500 text-xs">Pending Verification</div>
                                        <div class="text-2xl font-medium mt-1"><?php echo e($stats['payments']['pending']); ?></div>
                                    </div>
        ...
        <div class="2xl:border-l -mb-10 pb-10">
            <div class="2xl:pl-6 grid grid-cols-12 gap-x-6 2xl:gap-x-0 gap-y-6">
                            ...
                            <div class="space-y-3 p-5 max-h-96 overflow-y-auto">
                                <?php if($stats['vehicles']['pending'] > 0): ?>
                                    <div class="pb-3">
                                        ...
                                        <div class="text-slate-400 text-xs mt-1"><?php echo e(now()->format('H:i A')); ?></div>
                                        <div class="text-slate-500 text-xs mt-2"><?php echo e($stats['vehicles']['pending']); ?> vehicle(s) are waiting for verification and approval.</div>
                                        <div class="font-medium flex mt-4 gap-2">
                                            <a href="<?php echo e(route('admin.vehicles.pending')); ?>" class="btn btn-secondary py-1 px-2 text-xs">Review</a>
                                        </div>
                                    </div>
                                ...
                                <div class="pb-3">
                                    ...
                                    <div class="text-slate-400 text-xs mt-1"><?php echo e(now()->format('H:i A')); ?></div>
                                    <div class="text-slate-500 text-xs mt-2">All systems are operating normally. Total active sessions: <?php echo e($stats['bookings']['active']); ?></div>
                                </div>
                                <div class="border-b"></div>
                                ...
                                <div class="pb-3">
                                    ...
                                    <div class="text-slate-400 text-xs mt-1"><?php echo e(now()->format('H:i A')); ?></div>
                                    <div class="text-slate-500 text-xs mt-2">Today's bookings: <?php echo e($stats['bookings']['today']); ?>, New users: <?php echo e($stats['users']['new_today']); ?>, Revenue: $<?php echo e(number_format($stats['payments']['today_amount'], 0)); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-span-12 md:col-span-6 xl:col-span-12 mt-3">
                    ...
                    <div class="mt-5">
                        <div class="space-y-2">
                            <?php if(\Illuminate\Support\Facades\Route::has('admin.vehicles.pending') && $stats['vehicles']['pending'] > 0): ?>
                                <a href="<?php echo e(route('admin.vehicles.pending')); ?>" class="intro-x block box px-4 py-3 hover:shadow-md transition">
                                    <div class="flex items-center">
                                        <i data-lucide="alert-triangle" class="w-5 h-5 text-warning mr-3"></i>
                                        <div>
                                            <div class="font-medium text-sm">Pending Vehicles</div>
                                            <div class="text-xs text-slate-500"><?php echo e($stats['vehicles']['pending']); ?> awaiting review</div>
                                        </div>
                                    </div>
                                </a>
                            <?php endif; ?>

                            <?php if(\Illuminate\Support\Facades\Route::has('admin.permissions.index')): ?>
                                <a href="<?php echo e(route('admin.permissions.index')); ?>" class="intro-x block box px-4 py-3 hover:shadow-md transition">
                                    <div class="flex items-center">
                            ...
                            <?php if(\Illuminate\Support\Facades\Route::has('admin.system.health')): ?>
                                <a href="<?php echo e(route('admin.system.health')); ?>" class="intro-x block box px-4 py-3 hover:shadow-md transition">
                                    <div class="flex items-center">
                            ...
                            <?php if(\Illuminate\Support\Facades\Route::has('admin.reports.index')): ?>
                                <a href="<?php echo e(route('admin.reports.index')); ?>" class="intro-x block box px-4 py-3 hover:shadow-md transition">
                                    <div class="flex items-center">
                            ...
                            <?php if(\Illuminate\Support\Facades\Route::has('admin.permissions.roles')): ?>
                                <a href="<?php echo e(route('admin.permissions.roles')); ?>" class="intro-x block box px-4 py-3 hover:shadow-md transition">
                                    <div class="flex items-center">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /media/bot/7E246BE4246B9DC1/laragon/www/parking/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>